                        ...
                        <div className="row">
                                ...
                                <div className="row">
                                    <div className="col-md-12 col-pad wow fadeInLeft delay-04s">
                                        <div className="overview overview-box">
                                            <img
                                                src="{{ asset('/img/popular-places/popular-places.jpg') }}"
                                                alt="popular-places"
                                            />
                                            <div className="mask">
                                                <h2>New York</h2>
                                    ...
                                    <div className="col-md-6 col-sm-6 col-pad wow fadeInUp delay-04s">
                                        <div className="overview overview-box">
                                            <img
                                                src="{{ asset('/img/popular-places/popular-places-2.jpg') }}"
                                    ...
                                    <div className="col-md-6 col-sm-6 col-pad wow fadeInUp delay-04s">
                                        <div className="overview overview-box">
                                            <img
                                                src="{{ asset('/img/popular-places/popular-places-4.jpg') }}"
                            ...
                            <div className="col-lg-5 col-md-12 col-pad wow fadeInRight delay-04s">
                                <div className="overview aa overview-box">
                                    <img
                                        src="{{ asset('/img/popular-places/popular-places-3.jpg') }}"
