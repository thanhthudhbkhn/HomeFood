                    ...
                    <div className="row">
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div className="footer-item">
                                ...
                                <ul className="contact-info">
                                    ...
                                    <li>
                                        Email:{" "}
                                        <a href="mailto:homemade_food@gmail.com">homemade_food@gmail.com</a>
                                    </li>
                                    <li>
                                        Điện thoại:{" "}
                                        <a href="#">+84 3 123 456</a>
                                    </li>
                        ...
                        <div className="col-xl-2 col-lg-2 col-md-6 col-sm-6">
                            <div className="footer-item">
                                ...
                                <ul className="links">
                                    ...
                                    <li>
                                        <a href="#">
                                            <i className="fa fa-angle-right" />Properties Grid
                                        </a>
                                    </li>
                                    <li>
                                        <a href="#">
                                    ...
                                    <li>
                                        <a href="#">
                                            <i className="fa fa-angle-right" />Property Details
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                            <div className="footer-item clearfix">
                                <h4>
                                    Theo dõi thông tin mới nhất của Homemade Food
                                </h4>
