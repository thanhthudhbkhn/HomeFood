                ...
                var o = t.type,
                    a =
                        t.target.ownerDocument !== document
                            ...
                            : null,
                    n =
                        W() && t.target.ownerDocument !== top.document
                            ? [
                ...
                function t(t, a) {
                    if ((N(o), !A(o, t.target))) {
                        ...
                        ("y" === u && !n.overflowed[0]) ||
                            ...
                            V(o, (m - v * h).toString(), { dir: u, dur: d }));
                    }
                }
                if (e(this).data(a)) {
                    var o = e(this),
                        ...
                        (t[0]._focusTimeout = setTimeout(function() {
                            var e = [te(a)[0], te(a)[1]],
                                ...
                                i = [
                                    o[0] + e[0] >= 0 &&
                                        o[0] + e[0] <
                                            l.height() - a.outerHeight(!1),
                                    o[1] + e[1] >= 0 &&
                                        o[0] + e[1] <
                                            l.width() - a.outerWidth(!1)
                                ],
                                c =
                                    "yx" !== n.axis || i[0] || i[1]
                                        ? "all"
            ...
            V = function(t, o, n) {
                ...
                var s = t.data(a),
                    ...
                    p = c.callbacks.onTotalScrollOffset
                        ? q.call(t, c.callbacks.onTotalScrollOffset)
                        : [0, 0],
